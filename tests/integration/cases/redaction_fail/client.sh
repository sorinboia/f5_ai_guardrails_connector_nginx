...
REQUEST="$REPO_ROOT/tests/fixtures/requests/redact_fail_chat.json"
...
grep -q "Guardrails blocked this request" "$OUT" || { echo "Missing default block body"; exit 1; }

echo "redaction_fail ok"
