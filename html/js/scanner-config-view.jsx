          ...
          <div className="space-y-10">
            ...
            >
              <p className="text-sm text-slate-600">
                Certificates are generated by mitmdump under <code className="font-mono text-xs">/root/.mitmproxy/</code>. If a download returns 404, start the proxy once to create them.
              </p>
