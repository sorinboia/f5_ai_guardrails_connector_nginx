        ...
        <form onSubmit={saveConfig} className="grid gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <div className="space-y-10">
            ...
            <SectionCard
              ...
              description="Download the mitmdump root CA so clients can trust the proxy on port 10000."
            >
              <p className="text-sm text-slate-600">
                Certificates are generated by mitmdump under <code className="font-mono text-xs">/var/lib/mitmproxy/</code>. If a download returns 404, start the proxy once to create them.
              </p>
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  ...
                  href="/config/mitm/mitmproxy-ca-cert.pem"
                  download
                >
                  ⬇️ Download PEM (.pem)
                </a>
                <a
                  className="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50"
                  href="/config/mitm/mitmproxy-ca-cert.cer"
                  download
                >
                  ⬇️ Download DER (.cer)
                </a>
